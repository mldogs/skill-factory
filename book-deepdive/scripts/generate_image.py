...
def normalize_to_extension(img_bytes, out_path):
    ...
    which can trip an image_signature_mismatch check downstream. Convert via
...
# Centralized art direction — appended to EVERY prompt so all images on a page
# share one consistent look. Prompts should describe the SUBJECT only.
